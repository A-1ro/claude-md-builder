...
export const WebPreviewConsole = ({
  ...
  return (
    <Collapsible
      ...
      {...props}
    >
      <CollapsibleTrigger className="flex w-full cursor-pointer items-center justify-between p-4 text-left font-medium hover:bg-muted/50 focus-visible:outline-none">Console
                    <ChevronDownIcon
                      className={cn(
